      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              >
                <a href="/" className="relative">
                  ...
                  <Image
                    ...
                    alt="Logo"
                    className="hidden sdark:block"
                  />
                </a>

                <p className="mb-10 mt-5">
                Helping you go Online - by Abed El Razzak Chreim
                </p>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="https://wa.me/96171441380" target="/blank"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        Whatsapp
                      </a>
                ...
                >
                  ...
                  <p className="mb-4 w-[90%]">
                    Contact me to receive a free Quotation
                  </p>
                  <p className="mb-4 w-[90%]">
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} ABC Development. All rights reserved
              </p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://www.instagram.com/abc_development_lb/" target="/blank" aria-label="social icon">
                    <svg
                    ...
                    >
                      <g clipPath="url(#clip0_48_1499)">
                        {/* <path
                          ...
                          fill=""
                        /> */}
                        <path fill="" d="M7 2C4.24 2 2 4.24 2 7V17C2 19.76 4.24 22 7 22H17C19.76 22 22 19.76 22 17V7C22 4.24 19.76 2 17 2H7ZM12 7C14.76 7 17 9.24 17 12C17 14.76 14.76 17 12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7ZM12 9.5C10.34 9.5 9 10.84 9 12.5C9 14.16 10.34 15.5 12 15.5C13.66 15.5 15 14.16 15 12.5C15 10.84 13.66 9.5 12 9.5ZM18.5 6C19.33 6 20 6.67 20 7.5C20 8.33 19.33 9 18.5 9C17.67 9 17 8.33 17 7.5C17 6.67 17.67 6 18.5 6Z"/>
                      </g>
                      <defs>
                ...
                <li>
                  <a href="https://www.linkedin.com/in/abc-development/" target="/blank" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
