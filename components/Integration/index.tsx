      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `COMMUNICATION`,
              subtitle: `Fast Support, Anytime, Anywhere!`,
              description: `Get fast, reliable development and ongoing support with maintenance. Contact me anytime for seamless solutions!`,
            }}
          />
