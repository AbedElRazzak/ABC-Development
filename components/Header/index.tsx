        ...
        <div className="flex w-full items-center justify-between xl:w-1/4">
          <a href="/">
            <Image
              ...
              width={119.03}
              height={30}
              className="hidden w-full dark:block dark:invert dark:brightness-0"
            />
            <Image
              src="/images/logo/abc-logo-hd.png"
              alt="logo"
        ...
        >
          ...
          <div className="mt-7 flex items-center gap-6 xl:mt-0">
            ...
            <Link
              ...
              className="flex items-center justify-center rounded-full px-7.5 py-2.5 text-regular text-white duration-300 ease-in-out bsg-[#0D724A] bg-primary dark:bg-primary"
            >
              Email me
            </Link>
          </div>
